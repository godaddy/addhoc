...
One of the most important and immediate ways you can support this project is to answer questions on [Github][issues].
...
Ensure that every function in `addhoc` is documented and follows the standards set by [JSDoc]. Finally,
...
[issues]: https://github.com/godaddy/addhoc/issues
